...
// .svelte-kit/adapter-node/entries/pages/operator/_page.svelte.js
...
var Dict = class {
  ...
  getValByKey(lang, k, default_lang) {
    function findValue(k2) {
      for (let l in Object.keys(this.dict[k2])) {
        if (this.dict[k2][Object.keys(this.dict[k2])[l]]) {
          return this.dict[k2][Object.keys(this.dict[k2])[l]];
        }
      }
    }
    try {
      let res = this.dict[k][lang] ? this.dict[k][lang] : this.dict[k][default_lang] ? this.dict[k][default_lang] : findValue(k);
...
var Forward = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { status } = $$props;
  let { operator } = $$props;
  ...
  return `<div style="${"position: relative;right: 0px; top:70px"}">${slots.default ? slots.default({}) : ``}
</div>`;
});
var FileTransfer = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { operator } = $$props;
  if ($$props.operator === void 0 && $$bindings.operator && operator !== void 0)
    $$bindings.operator(operator);
  return `<div style="${"position: relative;right: 0px; top:70px"}">${slots.default ? slots.default({}) : ``}
    <input class="${"file-upload"}" accept="${"*,*"}" id="${"file"}" name="${"file"}" type="${"file"}" style="${"display: none"}">
</div>`;
});
var css$5 = {
  code: "textarea.svelte-eh0sdt:not([readonly]),input.svelte-eh0sdt:not([readonly]){color:rgb(35, 33, 158)}textarea.svelte-eh0sdt:not([readonly])::-moz-placeholder,input.svelte-eh0sdt:not([readonly])::-moz-placeholder{color:rgb(41, 128, 155)}textarea.svelte-eh0sdt:not([readonly])::placeholder,input.svelte-eh0sdt:not([readonly])::placeholder{color:rgb(41, 128, 155)}input.svelte-eh0sdt,input.svelte-eh0sdt:hover,input.svelte-eh0sdt:focus,input.svelte-eh0sdt:active,textarea.svelte-eh0sdt{background:transparent;border:0;border-style:none;border-color:transparent;outline:none;outline-offset:0;box-shadow:none;padding:0;font-size:.7em}",
  map: null
};
var Oper = create_ssr_component(($$result, $$props, $$bindings, slots) => {
...
var css$4 = {
  code: ".collapsible.svelte-cyf6cu{background-color:rgb(158, 158, 158);color:white;cursor:pointer;padding:18px;width:100%;border:none;text-align:left;outline:none;font-size:15px}.content.svelte-cyf6cu{padding:0 10px;max-height:0;overflow:hidden;transition:max-height 0.2s ease-out;background-color:#f1f1f1}input.svelte-cyf6cu:not([readonly])::-moz-placeholder{color:rgb(35, 33, 158)}input.svelte-cyf6cu:not([readonly])::placeholder{color:rgb(35, 33, 158)}input.svelte-cyf6cu,input.svelte-cyf6cu:hover,input.svelte-cyf6cu:focus,input.svelte-cyf6cu:active{background:transparent;border:0;border-style:none;border-color:transparent;outline:none;outline-offset:0;box-shadow:none;padding:0}",
  map: null
};
var Dep = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  ${dep.id !== "0" ? `<button class="${"collapsible svelte-cyf6cu"}"${add_attribute("owner", owner, 0)}${add_attribute("this", button, 0)}><input type="${"text"}" ${readonly ? "readonly" : ""} style="${"border-width: 0px;"}" placeholder="${"input dep name"}" class="${"svelte-cyf6cu"}"${add_attribute("value", dep.alias, 0)}>
    ${edited_display ? `${operator.email === operator.abonent ? `<svg height="${"30"}" width="${"30"}" style="${"position: relative;float:right"}"><glyph glyph-name="${"minus-circle"}" unicode="${"\uEFC0"}" horiz-adv-x="${"50"}"></glyph><g class="${"currentLayer"}"><path d="${"M500.2 62.5c-241.8 0-437.7 195.89999999999998-437.7 437.3 0 241.8 195.89999999999998 437.7 437.7 437.7 241.40000000000003 0 437.3-195.89999999999998 437.3-437.7 0-241.40000000000003-195.89999999999998-437.3-437.3-437.3z m301.59999999999997 466.5c-0.6999999999999318 9-2.199999999999932 19.100000000000023-4.699999999999932 30.299999999999955h-593.9000000000001c-2.499999999999943-11.199999999999932-4.299999999999926-21.699999999999932-5.0999999999999375-31.399999999999977-0.6999999999999886-9.699999999999932-1.0999999999999943-19.799999999999955-1.0999999999999943-30.299999999999955 0-9 0.4000000000000057-18 1.0999999999999943-26.700000000000045 0.700000000000017-9 2.5-19.099999999999966 5.099999999999994-30.299999999999955h593.9000000000001c2.4999999999998863 11.199999999999989 3.9999999999998863 21.599999999999966 4.699999999999818 31.399999999999977 1.1000000000000227 9.699999999999989 1.400000000000091 19.80000000000001 1.400000000000091 30.30000000000001 0.09999999999990905 9.099999999999966-0.3000000000000682 17.69999999999999-1.400000000000091 26.69999999999999z"}" transform="${"scale(.03)"}" style="${"fill:lightgrey; stroke:black; stroke-width:20px"}"></path></g></svg>` : ``}` : ``}</button>` : ``}

  <div class="${"content svelte-cyf6cu"}" style="${"max-height:0px"}"${add_attribute("this", content, 0)}><br>
    ${dep.admin ? `<div>${validate_component(Oper, "Oper").$$render(
      $$result,
      {
        id: dep.admin.id,
        operator,
    ...
    ${dep.staff ? `${each(dep.staff, (user, u) => {
...
var css$3 = {
  code: ".svelte-a8k4ea::-webkit-scrollbar{display:none}",
  map: null
};
var Callcenter = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `<div class="${"deps_div svelte-a8k4ea"}" style="${"height: 100vh; overflow-y: scroll;"}">${each(cc_data, (dep, i) => {
      return `<br class="${"svelte-a8k4ea"}">
        ${validate_component(Dep, "Dep").$$render(
        $$result,
        {
...
var Landpage = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { rtc } = $$props;
  let lang = "en";
  langs.subscribe((data) => {
    if (data)
...
var dc_msg = writable();
var DataChannelOperator = class extends DataChannel {
  constructor(rtc, pc2) {
    super(rtc, pc2);
    let that2 = this;
    that2.cnt_call = 0;
...
var RTCOperator = class extends RTCBase {
...
var css$2 = {
  code: "[status='call'].svelte-nv6nfj.svelte-nv6nfj{transform:rotate(0deg) !important;-webkit-animation-iteration-count:infinite;animation-iteration-count:infinite}[status='call'].svelte-nv6nfj g.svelte-nv6nfj{fill:orange\r\n    }[status='talk'].svelte-nv6nfj.svelte-nv6nfj{transform:rotate(0deg) !important}[status='talk'].svelte-nv6nfj g.svelte-nv6nfj{fill:green\r\n    }[status='muted'].svelte-nv6nfj.svelte-nv6nfj{transform:rotate(120deg) !important;color:#232323}[status='inactive'].svelte-nv6nfj.svelte-nv6nfj{color:#dea677;transform:rotate(120deg)}[status='inactive'].svelte-nv6nfj g.svelte-nv6nfj{fill:grey}[status='active'].svelte-nv6nfj.svelte-nv6nfj{transform:rotate(120deg);color:black;opacity:1}[status='active'].svelte-nv6nfj g.svelte-nv6nfj{fill:orange}[status='busy'].svelte-nv6nfj.svelte-nv6nfj{transform:rotate(120deg);opacity:0.3;color:indianred}@-webkit-keyframes svelte-nv6nfj-shake{0%{transform:translate(1px, 1px) rotate(0deg)}10%{transform:translate(-1px, -2px) rotate(-1deg)}20%{transform:translate(-3px, 0px) rotate(1deg)}30%{transform:translate(3px, 2px) rotate(0deg)}40%{transform:translate(1px, -1px) rotate(1deg)}50%{transform:translate(-1px, 2px) rotate(-1deg)}60%{transform:translate(-3px, 1px) rotate(0deg)}70%{transform:translate(3px, 1px) rotate(-1deg)}80%{transform:translate(-1px, -1px) rotate(1deg)}90%{transform:translate(1px, 2px) rotate(0deg)}100%{transform:translate(1px, -2px) rotate(-1deg)}}@keyframes svelte-nv6nfj-shake{0%{transform:translate(1px, 1px) rotate(0deg)}10%{transform:translate(-1px, -2px) rotate(-1deg)}20%{transform:translate(-3px, 0px) rotate(1deg)}30%{transform:translate(3px, 2px) rotate(0deg)}40%{transform:translate(1px, -1px) rotate(1deg)}50%{transform:translate(-1px, 2px) rotate(-1deg)}60%{transform:translate(-3px, 1px) rotate(0deg)}70%{transform:translate(3px, 1px) rotate(-1deg)}80%{transform:translate(-1px, -1px) rotate(1deg)}90%{transform:translate(1px, 2px) rotate(0deg)}100%{transform:translate(1px, -2px) rotate(-1deg)}}",
  map: null
};
var CallButtonOperator = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="${"callObject"}" style="${"display: block;"}"><svg class="${"callButton svelte-nv6nfj"}"${add_attribute("status", status, 0)} width="${"50"}" height="${"50"}" style="${"position:absolute;left:0px;top:5px;z-index: 30;"}"><g class="${"currentLayer svelte-nv6nfj"}" style="${"stroke:lightgrey; stroke-width:10px"}"><title>Layer 1</title><path d="${"M390.7 353.3c-120.30000000000001 69.5 63.19999999999999 413.59999999999997 194.90000000000003 337.59999999999997l122.10000000000002 211.39999999999998c-55.60000000000002 32.10000000000002-102.5 52.30000000000007-166.9000000000001 15.5-178.79999999999995-102.19999999999993-375.59999999999997-442.9-369.99999999999994-646.0999999999999 1.8999999999999773-70.60000000000005 43.599999999999994-98.30000000000004 97.89999999999998-129.70000000000005 23.30000000000001 40.400000000000006 98.60000000000002 170.8 122 211.3z m50.400000000000034-5.699999999999989c-13 7.5-29.700000000000045 3.099999999999966-37.30000000000001-10l-115-199.3c-7.5-13.000000000000014-3.1000000000000227-29.700000000000017 10-37.30000000000001l60.5-34.900000000000006c13-7.499999999999993 29.69999999999999-3.0999999999999943 37.30000000000001 10l115.09999999999997 199.29999999999998c7.500000000000057 13 3.099999999999966 29.700000000000045-10 37.200000000000045l-60.599999999999966 35z m314.4 544.5c-13 7.5-29.700000000000045 3.1000000000000227-37.299999999999955-10l-115-199.30000000000007c-7.5-13-3.1000000000000227-29.699999999999932 10-37.299999999999955l60.5-34.89999999999998c13-7.5 29.699999999999932-3.1000000000000227 37.299999999999955 10l115.10000000000002 199.29999999999995c7.5 13 3.1000000000000227 29.700000000000045-10 37.30000000000007l-60.60000000000002 34.89999999999998z"}" id="${"svg_1"}" class="${"selected"}" transform="${"scale(.04)"}"></path></g></svg>
...
var css$1 = {
  code: "button.svelte-46odli.svelte-46odli{position:absolute;right:10px;top:0px;margin:5px;z-index:100;background-color:Transparent;background-repeat:no-repeat;border:none;cursor:pointer;overflow:hidden;outline:none}svg.svelte-46odli line.svelte-46odli{stroke:currentColor;stroke-width:3}.open.svelte-46odli #top.svelte-46odli{transform:translate(8px, 0px) rotate(45deg)\r\n    }.open.svelte-46odli #mid.svelte-46odli{opacity:0\r\n    }.open.svelte-46odli #bot.svelte-46odli{transform:translate(-15px, 8px) rotate(-45deg)\r\n    }",
  map: null
};
var BurgerButton = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<button style="${"position:fixed;transition: color " + escape(duration, true) + "s ease-in-out; color: " + escape(open ? menuColor : burgerColor, true) + ";"}" class="${["svelte-46odli", open ? "open" : ""].join(" ").trim()}"><svg width="${"26"}" height="${"26"}" class="${"svelte-46odli"}"><line id="${"top"}" x1="${"0"}" y1="${"8"}" x2="${"26"}" y2="${"8"}" style="${"transition: transform " + escape(duration, true) + "s ease-in-out, opacity " + escape(duration, true) + "s ease-in-out;"}" class="${"svelte-46odli"}"></line><line id="${"mid"}" x1="${"0"}" y1="${"16"}" x2="${"26"}" y2="${"16"}" style="${"transition: transform " + escape(duration, true) + "s ease-in-out, opacity " + escape(duration, true) + "s ease-in-out;"}" class="${"svelte-46odli"}"></line><line id="${"bot"}" x1="${"0"}" y1="${"24"}" x2="${"26"}" y2="${"24"}" style="${"transition: transform " + escape(duration, true) + "s ease-in-out, opacity " + escape(duration, true) + "s ease-in-out;"}" class="${"svelte-46odli"}"></line></svg>
</button>`;
});
var css = {
  code: "#container.svelte-2zb9xy{position:absolute;height:100vh;top:0px;overflow-y:auto}#menu.svelte-2zb9xy{text-align:left}",
  map: null
};
var SideMenu = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { open } = $$props;
  let { duration } = $$props;
  let { width } = $$props;
  let { padding } = $$props;
  ...
  if ($$props.menuColor === void 0 && $$bindings.menuColor && menuColor !== void 0)
    $$bindings.menuColor(menuColor);
  $$result.css.add(css);
  return `<div id="${"container"}" style="${"position:fixed;z-index:1;background-color: " + escape(backgroundColor, true) + "; color: " + escape(menuColor, true) + "; width: " + escape(width, true) + "; right: " + escape(open ? "0px" : "-" + (parseInt(width) + 10) + "px", true) + "; transition: right " + escape(duration, true) + "s ease-in-out"}" class="${"svelte-2zb9xy"}"><div id="${"menu"}" style="${"padding: " + escape(padding, true) + "; padding-top: " + escape(paddingTop, true) + ";"}" class="${"svelte-2zb9xy"}">${slots.default ? slots.default({}) : ``}</div></div>`;
});
var BurgerMenu = create_ssr_component(($$result, $$props, $$bindings, slots) => {
...
var Video_local = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<video id="${"localVideo"}" autoplay playsinline muted style="${"display: " + escape(display, true) + "; position:absolute; top:0px; width:130%; height: 100px; z-index: 20;"}"></video>
${slots.footer ? slots.footer({}) : ``}`;
});
var Video_remote = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `
    ...
    <video id="${"remoteVideo"}" autoplay playsinline${add_attribute("poster", poster, 0)} style="${"display:" + escape(display, true) + "; position: absolute; height: 105px; background-color: white; max-width: 12%; z-index: 10;"}"><track kind="${"captions"}"></video>

    ${slots.default ? slots.default({}) : ``}`;
});
var Download = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  return `<a id="${"download_href"}" style="${"display:none;"}"></a>
<form id="${"fileInfo"}" style="${"display: none"}"><input type="${"file"}" id="${"fileInput"}" name="${"files"}"></form>

<i class="${"fa fa-spinner fa-spin"}" style="${"position:absolute; top:50%;left:50%;font-size:44px;"}"></i>`;
});
var Audio_local = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { paused = true } = $$props;
  if ($$props.paused === void 0 && $$bindings.paused && paused !== void 0)
    $$bindings.paused(paused);
  return `<audio id="${"localSound"}" src="${"../src/routes/assets/mp3/ring.mp3"}"><track kind="${"captions"}"></audio>`;
});
var Audio_remote = create_ssr_component(($$result, $$props, $$bindings, slots) => {
...
var RecordedVideo = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let { display = "none" } = $$props;
  if ($$props.display === void 0 && $$bindings.display && display !== void 0)
    $$bindings.display(display);
...
var Operator = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $langs, $$unsubscribe_langs;
  $$unsubscribe_langs = subscribe(langs, (value) => $langs = value);
  let callcenter;
  ...
  if ($$props.data_dict === void 0 && $$bindings.data_dict && data_dict !== void 0)
    $$bindings.data_dict(data_dict);
  if ($$props.tarif === void 0 && $$bindings.tarif && tarif2 !== void 0)
    $$bindings.tarif(tarif2);
  if ($$props.operator === void 0 && $$bindings.operator && operator !== void 0)
    $$bindings.operator(operator);
  ...
  do {
    ...
    $$rendered = `<div style="${"display:flex; min-height:120px; flex-wrap: nowrap;justify-content: space-between;"}"><div style="${"flex:1"}">${validate_component(Video_remote, "VideoRemote").$$render($$result, Object.assign(remote.video), {}, {})}

                ${validate_component(CallButtonOperator, "CallButton").$$render(
      $$result,
      { OnLongPress, status },
      {
        status: ($$value) => {
      ...
      {}
                ...
                ${validate_component(RecordedVideo, "RecordedVideo").$$render($$result, {}, {}, {})}
                ${validate_component(Download, "Download").$$render($$result, {}, {}, {})}</div>
   
        ${validate_component(BurgerMenu, "BurgerMenu").$$render($$result, { padding: "25px" }, {}, {
      default: () => {
        return `
                
                        ${escape(dict["Language Select"][lang])}:
                
                <div style="${"display: flex; margin-bottom:20px"}"><label style="${"flex:1"}"><input type="${"radio"}" name="${"lang"}"${add_attribute("value", "en", 0)}${"en" === lang ? add_attribute("checked", true, 1) : ""}>
                                <img src="${"https://www.sic-info.org/wp-content/uploads/2014/01/gb.png"}" alt="${"English"}"></label>
                
                        <label style="${"flex:1"}"><input type="${"radio"}" name="${"lang"}"${add_attribute("value", "fr", 0)}${"fr" === lang ? add_attribute("checked", true, 1) : ""}>
                                <img src="${"https://www.sic-info.org/wp-content/uploads/2014/01/fr.png"}" alt="${"French"}"></label>
                
                        <label style="${"flex:1"}"><input type="${"radio"}" name="${"lang"}"${add_attribute("value", "ru", 0)}${"ru" === lang ? add_attribute("checked", true, 1) : ""}>
                                <img src="${"https://www.sic-info.org/wp-content/uploads/2014/01/ru.png"}" alt="${"Russian"}"></label></div>
                ${operator ? `${!edited_display ? `<h5>${escape(dict["Edit Call Center"][lang])}</h5>` : `<h5>${escape(dict["Cancel Edit Call Center"][lang])}</h5>`}` : ``}
                
                ${operator.email !== operator.abonent ? `<h5>${escape(dict["Create my own net"][lang])}</h5>` : ``}`;
      }
    })}</div>

<progress id="${"dataProgress"}"${add_attribute("value", progress.value, 0)} max="${"100"}" duration="${"200"}" style="${"display:" + escape(progress.display, true) + ";top:100px;width:98%;z-index:10"}"></progress>

${(!tarif2 || tarif2.name === "free") && !operator.abonent ? `${validate_component(Landpage, "Landpage").$$render($$result, { tarif: tarif2 }, {}, {})}` : `${validate_component(Callcenter, "Callcenter").$$render(
      $$result,
      {
        tarif: tarif2,
        psw,
...
//# sourceMappingURL=_page.svelte-YBPKKDLT.js.map
