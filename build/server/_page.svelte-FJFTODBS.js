...
// .svelte-kit/adapter-node/entries/pages/website/todos/_page.svelte.js
var css = {
...
<div class="${"todos svelte-q3kvo1"}"><h1>Todos</h1>
    ...
    return `<div class="${["todo svelte-q3kvo1", todo.done ? "done" : ""].join(" ").trim()}"><form action="${"/todos?_method=PATCH"}" method="${"post"}"><input type="${"hidden"}" name="${"uid"}"${add_attribute("value", todo.uid, 0)} class="${"svelte-q3kvo1"}">
				...
				<button class="${"toggle svelte-q3kvo1"}" aria-label="${"Mark todo as " + escape(todo.done ? "not done" : "done", true)}"></button></form>
...
//# sourceMappingURL=_page.svelte-FJFTODBS.js.map
