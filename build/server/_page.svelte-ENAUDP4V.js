...
var css$5 = {
  code: "textarea.svelte-maubz2:not([readonly]),input.svelte-maubz2:not([readonly]){color:rgb(35, 33, 158)}textarea.svelte-maubz2:not([readonly])::placeholder,input.svelte-maubz2:not([readonly])::placeholder{color:rgb(41, 128, 155)}input.svelte-maubz2,input.svelte-maubz2:hover,input.svelte-maubz2:focus,input.svelte-maubz2:active,textarea.svelte-maubz2{background:transparent;border:0;border-style:none;border-color:transparent;outline:none;outline-offset:0;box-shadow:none;padding:0;font-size:.7em}",
  map: null
};
var Oper = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    ${edited_display ? `<input class="${"file-upload svelte-maubz2"}" accept="${"image/png, image/jpeg"}" id="${"avatar"}" name="${"avatar"}" type="${"file"}" style="${"display: none"}">` : ``}
  ...
  <div style="${"flex:1; margin-left:10px"}">${dict ? `<input type="${"text"}" class="${"user_name svelte-maubz2"}"${add_attribute("placeholder", placeholder_name, 0)} ${readonlyOper ? "readonly" : ""} style="${"width:80%;"}"${add_attribute("value", user.name, 0)}>
      <input type="${"text"}" class="${"user_email svelte-maubz2"}"${add_attribute("placeholder", placeholder_email, 0)} ${readonlyAdm ? "readonly" : ""} style="${"width:100%; max-height: 100px;"}"${add_attribute("value", user.email, 0)}>` : ``}
    <textarea type="${"text"}" rows="${"3"}" class="${"user_desc svelte-maubz2"}"${add_attribute("placeholder", placeholder_desc, 0)} ${readonlyOper ? "readonly" : ""} style="${"width:85%;overflow:auto;max-height: 100px;resize:none"}">${user.desc || ""}</textarea></div>
...
var Dep = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  ${dep.id !== "0" ? `<button class="${"collapsible svelte-1fx3n49"}"${add_attribute("owner", owner, 0)}${add_attribute("this", button, 0)}><input type="${"text"}" ${readonly ? "readonly" : ""} style="${"border-width: 0px;"}" placeholder="${"input dep name"}" class="${"svelte-1fx3n49"}"${add_attribute("value", dep.alias, 0)}>
  ...
  <div class="${"content svelte-1fx3n49"}" style="${"max-height:0px"}"${add_attribute("this", content, 0)}><br>
...
var BurgerButton = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<button style="${"position:fixed;transition: color " + escape(duration, true) + "s ease-in-out; color: " + escape(open ? menuColor : burgerColor, true) + ";"}" class="${["svelte-15ez1si", open ? "open" : ""].join(" ").trim()}"><svg width="${"26"}" height="${"26"}" class="${"svelte-15ez1si"}"><line id="${"top"}" x1="${"0"}" y1="${"8"}" x2="${"26"}" y2="${"8"}" style="${"transition: transform " + escape(duration, true) + "s ease-in-out, opacity " + escape(duration, true) + "s ease-in-out;"}" class="${"svelte-15ez1si"}"></line><line id="${"mid"}" x1="${"0"}" y1="${"16"}" x2="${"26"}" y2="${"16"}" style="${"transition: transform " + escape(duration, true) + "s ease-in-out, opacity " + escape(duration, true) + "s ease-in-out;"}" class="${"svelte-15ez1si"}"></line><line id="${"bot"}" x1="${"0"}" y1="${"24"}" x2="${"26"}" y2="${"24"}" style="${"transition: transform " + escape(duration, true) + "s ease-in-out, opacity " + escape(duration, true) + "s ease-in-out;"}" class="${"svelte-15ez1si"}"></line></svg>
</button>`;
});
var css = {
...
//# sourceMappingURL=_page.svelte-ENAUDP4V.js.map
