...
var app = (function () {
    ...
    class RTCBase{
        ...
        onIceStateChange(pc, event) {
            ...
            if (pc) {
                ...
                if(pc.con.iceConnectionState==='new'){
                    utils.log(pc.pc_key +' ICE state change event: new', that);
                }

                if(pc.con.iceConnectionState==='checking'){
                    utils.log(pc.pc_key +' ICE state change event: checking', that);
                ...
                if(pc.con.iceConnectionState==='disconnected'){
                    utils.log(pc.pc_key +' ICE state change event: disconnected', that);
                    pc.con.restartIce();
                ...
                if(pc.con.iceConnectionState==='connected') {
                    ...
                    utils.log(pc.pc_key +' ICE state change event: connected', that);
                ...
                if(pc.con.iceConnectionState=== "failed") {
                    ...
                    utils.log(pc.pc_key +' ICE state change event: failed', that);
                ...
                if(pc.con.iceConnectionState==='completed') {
                    utils.log(pc.pc_key +' ICE state change event: completed', that);

                }
                utils.log(pc.pc_key +' ICE state change event: '+ event.type, that);
            }
        }
        ...
        getTracks(stream, cb){
            ...
            if (videoTracks.length > 0) {
                utils.log('Using video device: ' + videoTracks[0].label, that);
            }
            if (audioTracks.length > 0) {
                utils.log('Using audio device: ' + audioTracks[0].label, that);
            }
            cb(true);
        }
    ...
    class RTCUser extends RTCBase {
        ...
        constructor(abonent,type, em, uid) {
            ...
            this.abonent = utils.getParameterByName('abonent');
        ...
        OnMessage(data) {
            ...
            if (data.call || data.func === 'call') {
                utils.log("received call: " + data.call + " from " + that.type, that);
    ...
    function create_fragment$l(ctx) {
    	...
    	return {
    		c() {
    			...
    			div3.innerHTML = `<span style="display: block;
                text-align: center;
                margin-left: auto;
    			...
    			t12 = text(t12_value);
    			attr(h2, "class", "form-signin-heading");
    			...
    			attr(img, "id", "avatar_img");
    			attr(img, "alt", "avatar");
    			set_style(img, "display", "block");
    			set_style(img, "margin-left", "auto");
    			set_style(img, "margin-right", "auto");
    			set_style(img, "width", "40%");
    			attr(input2, "class", "file-upload");
    			attr(input2, "accept", "image/png, image/jpeg");
    			attr(input2, "id", "avatar");
    			attr(input2, "name", "avatar");
    			attr(input2, "type", "file");
    			set_style(input2, "display", "none");
    			attr(div5, "for", "send_form");
    			attr(button, "id", "send_form");
    			attr(button, "class", "btn btn-primary");
    			attr(div6, "class", "row");
    			set_style(div6, "border-style", "groove");
    			set_style(div6, "border-radius", "2px");
    			set_style(div6, "border-color", "#cbced2");
    		...
    		m(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen(img, "click", /*OnClickUpload*/ ctx[9]),
    					listen(input2, "change", /*OnChangeFile*/ ctx[10]),
    					listen(input2, "change", /*input2_change_handler*/ ctx[15]),
    					listen(button, "click", stop_propagation(prevent_default(/*OnClickSend*/ ctx[7]))),
    					action_destroyer(/*setForm*/ ctx[8].call(null, form_1))
    				];
    ...
    function instance$k($$self, $$props, $$invalidate) {
    			...
    			let data = await loadImage(
    				...
    				function (img, data) {
    					if (img.type === "error") {
    						...
    						$$invalidate(1, src = img.toDataURL());
    	...
    	$$self.$$set = $$props => {
    		if ('profile' in $$props) $$invalidate(11, profile = $$props.profile);
    ...
    class Profile extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$k, create_fragment$l, safe_not_equal, { profile: 11, selected: 12 });
    	}
    }
    ...
    /* src\user\kolmit\CallButtonUser.svelte generated by Svelte v3.40.2 */
    		...
    		m(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen(svg, "mute", /*mute_handler*/ ctx[5]),
    ...
    function instance$j($$self, $$props, $$invalidate) {
    	...
    	return [status, OnLongPress, $$scope, slots, click_handler, mute_handler];
    }

    class CallButtonUser extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$j, create_fragment$k, safe_not_equal, { status: 0, OnLongPress: 1 });
    	}
    }

    /* node_modules\svelma\src\components\Icon.svelte generated by Svelte v3.40.2 */
    ...
    function create_fragment$j(ctx) {
    	...
    	return {
    		c() {
    			span = element("span");
    			i = element("i");
    			attr(i, "class", i_class_value = "" + (/*newPack*/ ctx[8] + " fa-" + /*icon*/ ctx[0] + " " + /*customClass*/ ctx[2] + " " + /*newCustomSize*/ ctx[6]));
    			attr(span, "class", span_class_value = "icon " + /*size*/ ctx[1] + " " + /*newType*/ ctx[7] + " " + (/*isLeft*/ ctx[4] && 'is-left' || '') + " " + (/*isRight*/ ctx[5] && 'is-right' || ''));
    		...
    		m(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen(span, "click", /*click_handler*/ ctx[12]);
    				mounted = true;
    			}
    		},
    		p(ctx, [dirty]) {
    ...
    ***************************************************************************** */
    ...
    /* node_modules\svelma\src\components\Dialog\Dialog.svelte generated by Svelte v3.40.2 */
    ...
    function create_if_block$7(ctx) {
    	...
    	let if_block3 = /*showCancel*/ ctx[9] && create_if_block_1$4(ctx);
    	...
    	return {
    		c() {
    			...
    			attr(section, "class", "modal-card-body svelte-1gwiwqo");
    			toggle_class(section, "is-titleless", !/*title*/ ctx[2]);
    			toggle_class(section, "is-flex", /*icon*/ ctx[6]);
    			attr(button, "class", button_class_value = "button " + /*type*/ ctx[11] + " svelte-1gwiwqo");
    			attr(footer, "class", "modal-card-foot svelte-1gwiwqo");
    			attr(div3, "class", "modal-card svelte-1gwiwqo");
    			attr(div4, "class", div4_class_value = "modal dialog " + /*size*/ ctx[10] + " is-active" + " svelte-1gwiwqo");
    		},
    		m(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen(div0, "click", /*close*/ ctx[21]),
    					listen(button, "click", /*confirm*/ ctx[22])
    				];
    		...
    		p(new_ctx, dirty) {
    			...
    			if (!current || dirty[0] & /*confirmText*/ 16) set_data(t6, /*confirmText*/ ctx[4]);
    ...
    function create_if_block_4(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(header, "class", "modal-card-head svelte-1gwiwqo");
    		},
    		m(target, anchor) {
    ...
    function create_if_block_2$3(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div1, "class", "field svelte-1gwiwqo");
    		},
    		m(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen(input_1, "input", /*input_1_input_handler*/ ctx[28]),
    					listen(input_1, "keyup", /*keyup_handler*/ ctx[30])
    				];
    		...
    		p(ctx, dirty) {
    			...
    			toggle_class(input_1, "svelte-1gwiwqo", true);
    			if (dirty[0] & /*validationMessage*/ 131072) set_data(t1, /*validationMessage*/ ctx[17]);
    		},
    		d(detaching) {
    ...
    function create_if_block_1$4(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(button, "class", "button svelte-1gwiwqo");
    		},
    		m(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen(button, "click", /*cancel*/ ctx[20]);
    				mounted = true;
    			}
    		},
    		p(ctx, dirty) {
    			if (dirty[0] & /*cancelText*/ 32) set_data(t, /*cancelText*/ ctx[5]);
    		},
    		d(detaching) {
    ...
    function create_fragment$i(ctx) {
    	...
    	return {
    		...
    		m(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = listen(window, "keydown", /*keydown*/ ctx[23]);
    				mounted = true;
    			}
    		},
    		p(ctx, dirty) {
    ...
    Dialog.confirm = confirm$1;
    Dialog.prompt = prompt;

    /* node_modules\svelma\src\components\Modal\Modal.svelte generated by Svelte v3.40.2 */
    ...
    function create_if_block$6(ctx) {
    	...
    	return {
    		c() {
    			button = element("button");
    			attr(button, "class", "modal-close is-large");
    ...
    function create_fragment$h(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div2, "class", div2_class_value = "modal " + /*size*/ ctx[2]);
    		...
    		m(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen(window, "keydown", /*keydown*/ ctx[7]),
    ...
    /* node_modules\svelma\src\components\Modal\ModalCard.svelte generated by Svelte v3.40.2 */
    ...
    function create_fragment$g(ctx) {
    	...
    	return {
    		c() {
    			...
    			footer.innerHTML = `<button class="button is-success">Save changes</button> 
      <button class="button">Cancel</button>`;
    			...
    			attr(div2, "class", div2_class_value = "modal " + /*size*/ ctx[3]);
    			toggle_class(div2, "is-active", /*active*/ ctx[0]);
    		},
    		m(target, anchor) {
    			insert(target, div2, anchor);
    ...
    class ModalCard extends SvelteComponent {
    	constructor(options) {
    		super();
    ...
    /* node_modules\svelma\src\components\Notices.svelte generated by Svelte v3.40.2 */
    ...
    function create_fragment$f(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			attr(div, "class", div_class_value = "notices " + /*positionClass*/ ctx[1] + " svelte-gicv46");
    		},
    		m(target, anchor) {
    			insert(target, div, anchor);
    ...
    class Notices extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$e, create_fragment$f, safe_not_equal, { position: 2, insert: 3 });
    	}
    ...
    /* node_modules\svelma\src\components\Notice.svelte generated by Svelte v3.40.2 */
    ...
    function create_if_block$5(ctx) {
    	...
    	return {
    		c() {
    			div = element("div");
    			if (default_slot) default_slot.c();
    			attr(div, "class", div_class_value = "notice " + /*position*/ ctx[1] + " svelte-x3pnf9");
    			attr(div, "aria-hidden", div_aria_hidden_value = !/*active*/ ctx[0]);
    		},
    		m(target, anchor) {
    			insert(target, div, anchor);
    			...
    			if (!mounted) {
    				dispose = listen(div, "outroend", /*remove*/ ctx[5]);
    				mounted = true;
    			}
    		},
    		p(new_ctx, dirty) {
    ...
    /* node_modules\svelma\src\components\Notification\Notification.svelte generated by Svelte v3.40.2 */
    ...
    function create_if_block$4(ctx) {
    	...
    	return {
    		c() {
    			...
    			div0 = element("div");
    			if (default_slot) default_slot.c();
    			attr(div0, "class", "media-content");
    			attr(div1, "class", "media svelte-1j2lhcz");
    			attr(article, "class", article_class_value = "notification " + /*type*/ ctx[1] + " svelte-1j2lhcz");
    		},
    		m(target, anchor) {
    ...
    function create_if_block_2$2(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(button, "aria-label", /*ariaCloseLabel*/ ctx[5]);
    		},
    		m(target, anchor) {
    			insert(target, button, anchor);

    			if (!mounted) {
    				dispose = listen(button, "click", /*close*/ ctx[7]);
    				mounted = true;
    			}
    		},
    		p(ctx, dirty) {
    ...
    /* node_modules\svelma\src\components\Notification\NotificationNotice.svelte generated by Svelte v3.40.2 */
    ...
    function create_default_slot$4(ctx) {
    	...
    	notification = new Notification({ props: notification_props });
    ...
    function create_fragment$c(ctx) {
    	...
    	notice = new Notice({ props: notice_props });
    ...
    class NotificationNotice extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$b, create_fragment$c, safe_not_equal, { message: 0, duration: 3, position: 4 });
    	}
    }
    ...
    /* node_modules\svelma\src\components\Select.svelte generated by Svelte v3.40.2 */
    ...
    function create_else_block(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(select, "size", /*nativeSize*/ ctx[5]);
    		...
    		m(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen(select, "change", /*select_change_handler_1*/ ctx[22]),
    					listen(select, "change", /*onChange*/ ctx[15]),
    					listen(select, "blur", /*onBlur*/ ctx[16]),
    					listen(select, "hover", /*onHover*/ ctx[17]),
    					listen(select, "focus", /*onFocus*/ ctx[18])
    				];
    ...
    function create_if_block_1$2(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block = /*placeholder*/ ctx[2] && /*selected*/ ctx[0] === '' && create_if_block_2$1(ctx);
    	const default_slot_template = /*#slots*/ ctx[20].default;
    	const default_slot = create_slot(default_slot_template, ctx, /*$$scope*/ ctx[19], null);
    ...
    function create_if_block_3(ctx) {
    	...
    	return {
    		...
    		p(ctx, dirty) {
    			if (dirty & /*placeholder*/ 4) set_data(t0, /*placeholder*/ ctx[2]);
    		},
    		d(detaching) {
    ...
    function create_fragment$b(ctx) {
    	...
    	return {
    		c() {
    			...
    			t = space();
    			if (if_block1) if_block1.c();
    			attr(span, "class", span_class_value = "select " + /*size*/ ctx[4] + " " + /*type*/ ctx[1]);
    ...
    /* node_modules\svelma\src\components\Snackbar\Snackbar.svelte generated by Svelte v3.40.2 */
    ...
    function create_if_block$2(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(button, "class", button_class_value = "button " + /*newType*/ ctx[5] + " svelte-6ks3pf");
    			attr(div, "class", "action svelte-6ks3pf");
    		},
    		m(target, anchor) {
    			insert(target, div, anchor);
    			append(div, button);
    			...
    			if (!mounted) {
    				dispose = listen(div, "click", /*action*/ ctx[6]);
    				mounted = true;
    			}
    		},
    		p(ctx, dirty) {
    			if (dirty & /*actionText*/ 4) set_data(t, /*actionText*/ ctx[2]);
    ...
    function create_default_slot$3(ctx) {
    	...
    	return {
    		c() {
    			...
    			t = space();
    			if (if_block) if_block.c();
    			attr(div0, "class", "text svelte-6ks3pf");
    			attr(div1, "class", div1_class_value = "snackbar " + /*background*/ ctx[1] + " svelte-6ks3pf");
    ...
    function create_fragment$a(ctx) {
    	...
    	notice_1 = new Notice({ props: notice_1_props });
    ...
    /* node_modules\svelma\src\components\Toast\Toast.svelte generated by Svelte v3.40.2 */
    ...
    function create_default_slot$2(ctx) {
    	...
    	return {
    		c() {
    			...
    			attr(div1, "class", div1_class_value = "toast " + /*type*/ ctx[1] + " " + /*newBackground*/ ctx[2] + " svelte-1ahpku3");
    			attr(div1, "role", "alert");
    		},
    		m(target, anchor) {
    			insert(target, div1, anchor);
    ...
    class Toast extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$8, create_fragment$9, safe_not_equal, { message: 0, type: 1, background: 4 });
    	}
    }
    ...
    /* src\user\kolmit\DropdownList.svelte generated by Svelte v3.40.2 */
    ...
    function create_each_block(key_1, ctx) {
    	...
    	let if_block0 = /*opt*/ ctx[8].id == 1 && /*status*/ ctx[1] === 'talk' && create_if_block_1$1(ctx);
    	let if_block1 = /*opt*/ ctx[8].id == 2 && create_if_block$1(ctx);
    	...
    	return {
    		...
    		p(new_ctx, dirty) {
    			...
    			if (/*opt*/ ctx[8].id == 1 && /*status*/ ctx[1] === 'talk') {
    				if (if_block0) {
    					if_block0.p(ctx, dirty);
    				} else {
    			...
    			if (/*opt*/ ctx[8].id == 2) if_block1.p(ctx, dirty);
    		},
    		d(detaching) {
    ...
    function create_fragment$8(ctx) {
    	...
    	select.$on("blur", /*OnBlurSelect*/ ctx[4]);
    ...
    function instance$7($$self, $$props, $$invalidate) {
    	let { display } = $$props;
    	let options = [{ id: 2, text: 'Open Profile' }, { id: 1, text: 'Transmit File' }];
    	let profile;
    	let { selected = '' } = $$props;
    	let { status } = $$props;
    ...
    class DropdownList extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$7, create_fragment$8, safe_not_equal, { display: 5, selected: 0, status: 1 });
    	}
    }

    /* src\user\kolmit\Video.local.svelte generated by Svelte v3.40.2 */
    ...
    /* src\user\kolmit\Video.remote.svelte generated by Svelte v3.40.2 */
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	onMount(async () => {
    		$$invalidate(2, rv = document.getElementById('remoteVideo'));
    	});
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*rv, srcObject*/ 6) {
    			if (rv && srcObject) {
    				$$invalidate(2, rv.srcObject = srcObject, rv);
    				...
    				$$invalidate(2, rv.src = '', rv);
    			}
    		}
    	};

    	return [display, srcObject, rv, $$scope, slots];
    }

    class Video_remote extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$5, create_fragment$6, safe_not_equal, { display: 0, srcObject: 1 });
    	}
    }

    /* src\user\kolmit\Download.svelte generated by Svelte v3.40.2 */
    ...
    /* src\user\kolmit\Audio.local.svelte generated by Svelte v3.40.2 */
    ...
    class Audio_local extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$4, create_fragment$4, safe_not_equal, { paused: 0 });
    	}
    }

    /* src\user\kolmit\Audio.remote.svelte generated by Svelte v3.40.2 */
    ...
    class Audio_remote extends SvelteComponent {
    	constructor(options) {
    		super();
    		init(this, options, instance$3, create_fragment$3, safe_not_equal, { muted: 0, srcObject: 1 });
    	}
    }

    /* src\user\kolmit\RecordedVideo.svelte generated by Svelte v3.40.2 */
    ...
    /* src\user\kolmit\User.svelte generated by Svelte v3.40.2 */

    function create_if_block_2(ctx) {
    	let profile_1;
    	let updating_profile;
    	let updating_selected;
    	let current;
    	...
    	if (/*selected*/ ctx[0] !== void 0) {
    		profile_1_props.selected = /*selected*/ ctx[0];
    	}

    	profile_1 = new Profile({ props: profile_1_props });
    	binding_callbacks.push(() => bind(profile_1, 'profile', profile_1_profile_binding));
    	binding_callbacks.push(() => bind(profile_1, 'selected', profile_1_selected_binding));
    	...
    	return {
    		...
    		p(ctx, dirty) {
    			...
    			if (!updating_selected && dirty[0] & /*selected*/ 1) {
    				updating_selected = true;
    				profile_1_changes.selected = /*selected*/ ctx[0];
    				add_flush_callback(() => updating_selected = false);
    			}
    ...
    function create_if_block(ctx) {
    	...
    	if (/*status*/ ctx[1] !== void 0) {
    		dropdownlist_props.status = /*status*/ ctx[1];
    	}

    	dropdownlist = new DropdownList({ props: dropdownlist_props });
    	binding_callbacks.push(() => bind(dropdownlist, 'display', dropdownlist_display_binding));
    	binding_callbacks.push(() => bind(dropdownlist, 'selected', dropdownlist_selected_binding));
    	binding_callbacks.push(() => bind(dropdownlist, 'list', dropdownlist_list_binding));
    	binding_callbacks.push(() => bind(dropdownlist, 'status', dropdownlist_status_binding));
    	...
    	return {
    		...
    		p(ctx, dirty) {
    			...
    			if (!updating_selected && dirty[0] & /*selected*/ 1) {
    				updating_selected = true;
    				dropdownlist_changes.selected = /*selected*/ ctx[0];
    				add_flush_callback(() => updating_selected = false);
    			}
    			...
    			if (!updating_status && dirty[0] & /*status*/ 2) {
    				updating_status = true;
    				dropdownlist_changes.status = /*status*/ ctx[1];
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		c() {
    			if (if_block0) if_block0.c();
    			t0 = space();
    			create_component(callbuttonuser.$$.fragment);
    			t1 = space();
    			...
    			attr(div, "class", "call_text");
    			set_style(div, "cb_display", "block");
    			set_style(div, "position", "absolute");
    			set_style(div, "top", "30px");
    			set_style(div, "overflow", "hidden");
    			set_style(div, "overflow-y", "auto");
    			set_style(div, "left", "0");
    			set_style(div, "widht", "100%");
    			set_style(div, "max-height", "300px");
    			set_style(div, "z-index", "101");
    			attr(input, "class", "file-upload");
    			attr(input, "accept", ".*|audio/*,video/*,image/*");
    			attr(input, "id", "files");
    		...
    		m(target, anchor) {
    			if (if_block0) if_block0.m(target, anchor);
    			insert(target, t0, anchor);
    			mount_component(callbuttonuser, target, anchor);
    			insert(target, t1, anchor);
    			mount_component(audiolocal, target, anchor);
    			insert(target, t2, anchor);
    			mount_component(audioremote, target, anchor);
    			insert(target, t3, anchor);
    			mount_component(videolocal, target, anchor);
    			insert(target, t4, anchor);
    			if (if_block1) if_block1.m(target, anchor);
    			insert(target, t5, anchor);
    			mount_component(videoremote, target, anchor);
    			insert(target, t6, anchor);
    			mount_component(recordedvideo, target, anchor);
    		...
    		p(ctx, dirty) {
    			...
    			const callbuttonuser_changes = {};

    			if (!updating_status && dirty[0] & /*status*/ 2) {
    				updating_status = true;
    				callbuttonuser_changes.status = /*status*/ ctx[1];
    				add_flush_callback(() => updating_status = false);
    			}
    		...
    		i(local) {
    			if (current) return;
    			transition_in(if_block0);
    			transition_in(callbuttonuser.$$.fragment, local);
    		...
    		o(local) {
    			transition_out(if_block0);
    			transition_out(callbuttonuser.$$.fragment, local);
    		...
    		d(detaching) {
    			if (if_block0) if_block0.d(detaching);
    			if (detaching) detach(t0);
    			destroy_component(callbuttonuser, detaching);
    			if (detaching) detach(t1);
    			destroy_component(audiolocal, detaching);
    			if (detaching) detach(t2);
    			destroy_component(audioremote, detaching);
    			if (detaching) detach(t3);
    			destroy_component(videolocal, detaching);
    			if (detaching) detach(t4);
    			if (if_block1) if_block1.d(detaching);
    			if (detaching) detach(t5);
    			destroy_component(videoremote, detaching);
    			if (detaching) detach(t6);
    			destroy_component(recordedvideo, detaching);
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	let em = url.searchParams.get("em")
    	? url.searchParams.get("em")
    	: "user@kolmit"; //getParameterByName('em')?getParameterByName('em'):'user@kolmit';
    	...
    	function OnMessage(data) {
    		if (data.operators && data.operators[window.user.em]) {
    			let res = lodash.groupBy(data.operators[window.user.em], "status");

    			if (res["offer"]) {
    				if (status !== "call" && status !== "wait") {
    					$$invalidate(1, status = "active");
    					const event = new Event("display");
    					event.data = "block";
    				}
    			} else if (res["busy"]) {
    				if (status !== "call") {
    					$$invalidate(1, status = "busy");
    					const event = new Event("display");
    					event.data = "none";
    		...
    		if (data.desc && data.cand) {
    			if (status === "talk") $$invalidate(1, status = "talk"); else $$invalidate(1, status = "call");
    		}
    	...
    	return [
    		...
    		OnClickCallButton,
    		OnClickVideoButton,
    		profile_1_profile_binding,
    		profile_1_selected_binding,
    		callbuttonuser_status_binding,
    		audiolocal_paused_binding,
    		audioremote_srcObject_binding,
    		dropdownlist_display_binding,
    		dropdownlist_selected_binding,
    		dropdownlist_list_binding,
    		dropdownlist_status_binding,
    ...
    /* src\user\App.svelte generated by Svelte v3.40.2 */
