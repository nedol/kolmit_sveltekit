  ...
  <div style="display:flex;justify-content: space-between;height:220px; margin:20px;">
      <div style="flex:0 0 4%">
          <div style="position:absolute;text-align: center;">
              ...
              <iframe class="kolmit" 
              src="../src/lib/user/iframe.svelte?em=biden@wh.com&abonent=white@house.usa" 
      ...
      <div style="flex:0 0 0%">
          <div style="position:absolute;text-align: center;">
              ...
              <iframe class="kolmit" 
              src="../src/lib/user/iframe.svelte?em=trump@wh.com&abonent=white@house.usa" 
      ...
      <div style="flex:0 0 20%">
          <div style="position:absolute;text-align: center;">
              ...
              <iframe class="kolmit" 
              src="../src/lib/user/iframe.svelte?em=obama@wh.com&abonent=white@house.usa" 
              scrolling="no" frameBorder="0" style="position: absolute;height:30px; width:100%;top:0;left:0;" title=''  
              on:load={OnLoad}>
              </iframe>
              <div>
