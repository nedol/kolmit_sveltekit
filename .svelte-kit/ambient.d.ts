...
declare module '$env/static/private' {
	...
	export const npm_package_dependencies_blueimp_load_image: string;
	export const npm_package_dependencies_bootstrap: string;
	export const npm_package_dependencies_lodash: string;
	export const npm_package_dependencies_md5: string;
	...
	export const npm_package_dependencies_sqlstring: string;
	export const npm_package_dependencies_ssr_cookie: string;
	export const npm_package_dependencies_string_hash: string;
	export const npm_package_dependencies_svelte_simple_modal: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		npm_package_dependencies_blueimp_load_image: string;
		npm_package_dependencies_bootstrap: string;
		npm_package_dependencies_lodash: string;
		npm_package_dependencies_md5: string;
		...
		npm_package_dependencies_sqlstring: string;
		npm_package_dependencies_ssr_cookie: string;
		npm_package_dependencies_string_hash: string;
		npm_package_dependencies_svelte_simple_modal: string;
