...
const css$8 = {
  code: ".collapsible.svelte-1k0fuvd.svelte-1k0fuvd{position:absolute;display:flex;align-items:center;background-color:white;color:rgb(3, 3, 3);cursor:pointer;padding:1px;max-width:250px;border:none;outline:none}.lang.svelte-1k0fuvd.svelte-1k0fuvd{display:flex;align-items:center;padding-top:10px}img.svelte-1k0fuvd.svelte-1k0fuvd{width:15px;margin-right:5px}.collapsible.svelte-1k0fuvd img.svelte-1k0fuvd{margin-left:0px}.content.svelte-1k0fuvd.svelte-1k0fuvd{position:absolute;left:0px;top:50px;max-width:200px;overflow:hidden;transition:max-height 0.2s ease-out;color:black;background-color:#f1f1f1}",
  map: null
};
const SelectMenu = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  options = [
    ...
    },
    {
      id: 1,
      lang: "en",
      src: "https://www.sic-info.org/wp-content/uploads/2014/01/nl.png",
      alt: "Nederlands"
    },
    {
      id: 2,
    ...
    },
    {
      id: 4,
      lang: "uk",
      src: "https://www.worldometers.info/img/flags/up-flag.gif",
      alt: "Український"
    },
    {
      id: 5,
      lang: "ru",
      src: "https://www.worldometers.info/img/flags/ru-flag.gif",
      alt: "Русский"
    }
  ];
  let selected = {
  ...
  return `<button class="button collapsible svelte-1k0fuvd"><div style="padding:10px"><img${add_attribute("src", selected.src, 0)} alt="" class="svelte-1k0fuvd">${escape(selected.alt)}</div> <div class="content svelte-1k0fuvd"${add_attribute("this", content, 0)}>${options ? `${each(options, (opt) => {
    return `   <span class="lang svelte-1k0fuvd"${add_attribute("value", opt.id, 0)}><img${add_attribute("src", opt.src, 0)} alt="" class="svelte-1k0fuvd">${escape(opt.alt)} </span>`;
  })}` : ``}</div> </button>`;
});
const icofont_min$1 = "";
let display = "block";
...
const css = {
  code: "@media screen and (min-width: 768px){button.svelte-za3vz4{padding:6px 10px;font-size:14px}input.svelte-za3vz4{padding:8px;font-size:14px}}@media screen and (max-width: 767px){button.svelte-za3vz4{padding:6px 10px;font-size:14px}input.svelte-za3vz4{padding:8px;font-size:14px}}form.svelte-za3vz4{display:flex;flex-direction:column;align-items:center;max-width:400px;margin:0 auto;padding:20px;border:1px solid #ccc;border-radius:5px;background-color:#fff}label.svelte-za3vz4{font-weight:bold;margin-top:10px}input[type='email'].svelte-za3vz4,input[type='text'].svelte-za3vz4,input[type='password'].svelte-za3vz4{width:100%;padding:10px;margin:5px 0;border:1px solid #ccc;border-radius:5px}input[type='file'].svelte-za3vz4{display:none}.user-pic-container.svelte-za3vz4{text-align:center;margin-top:10px}.user-pic.svelte-za3vz4{max-width:100px;max-height:100px;border-radius:50%;cursor:pointer}.upload-button.svelte-za3vz4{background-color:#0078d4;color:#fff;border:none;padding:10px 20px;border-radius:5px;cursor:pointer;margin-top:10px}",
  map: null
};
const Login = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  let $$unsubscribe_signal;
  $$unsubscribe_signal = subscribe(signal, (value) => value);
  let { oper_name, oper_pic } = $$props;
  if (!oper_pic) {
    oper_pic = operator_svg;
  }
  let { lang = "en", checked, abonent } = $$props;
  let email = "";
  let password = "demo";
  let confirmPassword = "demo";
  if ($$props.oper_name === void 0 && $$bindings.oper_name && oper_name !== void 0)
    $$bindings.oper_name(oper_name);
  if ($$props.oper_pic === void 0 && $$bindings.oper_pic && oper_pic !== void 0)
    $$bindings.oper_pic(oper_pic);
  if ($$props.lang === void 0 && $$bindings.lang && lang !== void 0)
    $$bindings.lang(lang);
  ...
  do {
    $$settled = true;
    $$result.head = previous_head;
    $$rendered = `${validate_component(SelectMenu, "SelectMenu").$$render(
      $$result,
      { lang },
      {
        lang: ($$value) => {
      ...
      {}
    )} <form class="svelte-za3vz4"><label for="email" class="svelte-za3vz4" data-svelte-h="svelte-1flf0h4">Email:</label> <input type="email" id="email" required class="svelte-za3vz4"${add_attribute("value", email, 0)}> <label for="oper_name" class="svelte-za3vz4" data-svelte-h="svelte-8gzyab">Имя:</label> <input type="text" id="oper_name" required class="svelte-za3vz4"${add_attribute("value", oper_name, 0)}> <label for="password" class="svelte-za3vz4" data-svelte-h="svelte-1httzzz">Пароль:</label> <input type="password" placeholder="input your password" required class="svelte-za3vz4"${add_attribute("value", password, 0)}> <label for="password" class="svelte-za3vz4" data-svelte-h="svelte-17nr0o2">Повторить пароль:</label> <input type="password" placeholder="repeat your password" required class="svelte-za3vz4"${add_attribute("value", confirmPassword, 0)}> <label for="oper_pic" class="svelte-za3vz4" data-svelte-h="svelte-vhq42e">Фотография профиля:</label> <input type="file" id="oper_pic" accept="image/png, image/jpeg" class="svelte-za3vz4"> <div class="user-pic-container svelte-za3vz4"><img class="user-pic svelte-za3vz4"${add_attribute("src", oper_pic, 0)} alt="Профиль пользователя"></div> <button class="upload-button svelte-za3vz4" data-svelte-h="svelte-vblypr">Зарегистрироваться</button></form> ${``}`;
  } while (!$$settled);
  $$unsubscribe_signal();
  return $$rendered;
});
