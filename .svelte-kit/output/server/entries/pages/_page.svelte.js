import { c as create_ssr_component, d as add_attribute, e as escape, f as each, a as subscribe, v as validate_component, b as set_store_value, s as setContext } from "../../chunks/ssr.js";
import "blueimp-load-image/js/load-image.js";
import "blueimp-load-image/js/load-image-scale.js";
import { p as posterst, s as signal, u as users, m as msg_signal_user, l as langs, e as editable, d as dicts, a as statust, o as operatorst, b as msg_signal_oper, v as view, i as ice_conf } from "../../chunks/stores2.js";
import md5 from "md5";
...
const css$7 = {
  code: ".collapsible.svelte-1d5ftok{position:absolute;right:0;background-color:rgb(158, 158, 158);color:white;cursor:pointer;padding:1px;max-width:105px;border:none;outline:none}.content.svelte-1d5ftok{position:absolute;right:0;padding:0px 18px;max-width:100px;max-height:0;overflow:hidden;transition:max-height 0.2s ease-out;background-color:#f1f1f1}",
  map: null
};
const SelectMenu = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<button class="button collapsible svelte-1d5ftok"><div style="padding:10px"><img${add_attribute("src", selected.src, 0)} alt="">${escape(selected.alt)}</div></button> <div class="content svelte-1d5ftok"${add_attribute("this", content, 0)}>${options ? `${each(options, (opt) => {
...
const css$6 = {
  code: ".callObject.svelte-1rc8o8m.svelte-1rc8o8m{display:block;position:absolute;max-width:100%;height:100%;top:0px;left:6px;z-index:10}.callButton.svelte-1rc8o8m.svelte-1rc8o8m{margin-left:-10px}[status='wait'].svelte-1rc8o8m.svelte-1rc8o8m{transform:rotate(0deg) !important;color:#69da12}[status='wait'].svelte-1rc8o8m g.svelte-1rc8o8m{fill:rgb(255, 255, 255)}[status='call'].svelte-1rc8o8m g.svelte-1rc8o8m{fill:orange}[status='talk'].svelte-1rc8o8m.svelte-1rc8o8m{transform:rotate(0deg) !important}[status='talk'].svelte-1rc8o8m g.svelte-1rc8o8m{fill:green}[status='muted'].svelte-1rc8o8m.svelte-1rc8o8m{transform:rotate(120deg) !important;color:#232323}[status='inactive'].svelte-1rc8o8m.svelte-1rc8o8m{color:#dea677;transform:rotate(120deg)}[status='inactive'].svelte-1rc8o8m g.svelte-1rc8o8m{fill:#fff0}[status='active'].svelte-1rc8o8m.svelte-1rc8o8m{transform:rotate(120deg);color:black}[status='active'].svelte-1rc8o8m g.svelte-1rc8o8m{fill:orange}[status='busy'].svelte-1rc8o8m.svelte-1rc8o8m{transform:rotate(120deg);opacity:0.3;color:indianred}@keyframes svelte-1rc8o8m-shake{0%{transform:translate(1px, 1px) rotate(0deg)}10%{transform:translate(-1px, -2px) rotate(-1deg)}20%{transform:translate(-3px, 0px) rotate(1deg)}30%{transform:translate(3px, 2px) rotate(0deg)}40%{transform:translate(1px, -1px) rotate(1deg)}50%{transform:translate(-1px, 2px) rotate(-1deg)}60%{transform:translate(-3px, 1px) rotate(0deg)}70%{transform:translate(3px, 1px) rotate(-1deg)}80%{transform:translate(-1px, -1px) rotate(1deg)}90%{transform:translate(1px, 2px) rotate(0deg)}100%{transform:translate(1px, -2px) rotate(-1deg)}}",
  map: null
};
...
const css$5 = {
  code: "textarea.svelte-1s97yno:not([readonly]),input.svelte-1s97yno:not([readonly]){color:rgb(35, 33, 158)}textarea.svelte-1s97yno:not([readonly])::placeholder,input.svelte-1s97yno:not([readonly])::placeholder{color:rgb(41, 128, 155)}input.svelte-1s97yno,input.svelte-1s97yno:hover,input.svelte-1s97yno:focus,input.svelte-1s97yno:active,textarea.svelte-1s97yno{background:transparent;border:0;border-style:none;border-color:transparent;outline:none;outline-offset:0;box-shadow:none;padding:0;font-size:0.7em}",
  map: null
};
...
const css$4 = {
  code: ".collapsible.svelte-wxdsc0{background-color:rgb(158, 158, 158);color:white;cursor:pointer;padding:18px;width:100%;border:none;text-align:left;outline:none;font-size:15px}.content.svelte-wxdsc0{padding:0 10px;max-height:0;overflow:hidden;transition:max-height 0.2s ease-out;background-color:#f1f1f1}input.svelte-wxdsc0:not([readonly])::placeholder{color:rgb(35, 33, 158)}input.svelte-wxdsc0,input.svelte-wxdsc0:hover,input.svelte-wxdsc0:focus,input.svelte-wxdsc0:active{background:transparent;border:0;border-style:none;border-color:transparent;outline:none;outline-offset:0;box-shadow:none;padding:0}",
  map: null
};
const Dep = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `  ${dep.id !== "0" ? `<button class="collapsible svelte-wxdsc0"${add_attribute("owner", owner, 0)}${add_attribute("this", button, 0)}><input type="text" ${readonly ? "readonly" : ""} style="border-width: 0px;" placeholder="input dep name" class="svelte-wxdsc0"${add_attribute("value", dep.alias, 0)}> ${edited_display ? `${operator.email === operator.abonent ? `  <svg height="30" width="30" style="position: relative;float:right"><glyph glyph-name="minus-circle" unicode="" horiz-adv-x="50"></glyph><g class="currentLayer"><path d="M500.2 62.5c-241.8 0-437.7 195.89999999999998-437.7 437.3 0 241.8 195.89999999999998 437.7 437.7 437.7 241.40000000000003 0 437.3-195.89999999999998 437.3-437.7 0-241.40000000000003-195.89999999999998-437.3-437.3-437.3z m301.59999999999997 466.5c-0.6999999999999318 9-2.199999999999932 19.100000000000023-4.699999999999932 30.299999999999955h-593.9000000000001c-2.499999999999943-11.199999999999932-4.299999999999926-21.699999999999932-5.0999999999999375-31.399999999999977-0.6999999999999886-9.699999999999932-1.0999999999999943-19.799999999999955-1.0999999999999943-30.299999999999955 0-9 0.4000000000000057-18 1.0999999999999943-26.700000000000045 0.700000000000017-9 2.5-19.099999999999966 5.099999999999994-30.299999999999955h593.9000000000001c2.4999999999998863 11.199999999999989 3.9999999999998863 21.599999999999966 4.699999999999818 31.399999999999977 1.1000000000000227 9.699999999999989 1.400000000000091 19.80000000000001 1.400000000000091 30.30000000000001 0.09999999999990905 9.099999999999966-0.3000000000000682 17.69999999999999-1.400000000000091 26.69999999999999z" transform="scale(.03)" style="fill:lightgrey; stroke:black; stroke-width:20px"></path></g></svg>` : ``}` : ``}</button>` : ``}  <div class="content svelte-wxdsc0" style="max-height:0px"${add_attribute("this", content, 0)}> ${dep.admin ? `<div>${validate_component(Oper, "Oper").$$render(
      $$result,
      {
        id: dep.admin.id,
        operator,
...
const css$3 = {
  code: ".svelte-1iqzrvs::-webkit-scrollbar{display:none}",
  map: null
};
const Callcenter = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  do {
    ...
    $$rendered = `<div style="${"display:" + escape(display2, true)}" class="svelte-1iqzrvs"><div class="deps_div svelte-1iqzrvs" style="height: 100vh; overflow-y: scroll;"> ${each(cc_data, (dep, i) => {
      return `<br class="svelte-1iqzrvs">  ${validate_component(Dep, "Dep").$$render(
        $$result,
        {
...
const css$2 = {
  code: "[status='call'].svelte-jaz7he.svelte-jaz7he{transform:rotate(0deg) !important;animation-iteration-count:infinite}[status='call'].svelte-jaz7he g.svelte-jaz7he{fill:orange\r\n    }[status='talk'].svelte-jaz7he.svelte-jaz7he{transform:rotate(0deg) !important}[status='talk'].svelte-jaz7he g.svelte-jaz7he{fill:green\r\n    }[status='muted'].svelte-jaz7he.svelte-jaz7he{transform:rotate(120deg) !important;color:#232323}[status='inactive'].svelte-jaz7he.svelte-jaz7he{color:#dea677;transform:rotate(120deg)}[status='inactive'].svelte-jaz7he g.svelte-jaz7he{fill:grey}[status='active'].svelte-jaz7he.svelte-jaz7he{transform:rotate(120deg);color:black;opacity:1}[status='active'].svelte-jaz7he g.svelte-jaz7he{fill:orange}[status='busy'].svelte-jaz7he.svelte-jaz7he{transform:rotate(120deg);opacity:0.3;color:indianred}@keyframes svelte-jaz7he-shake{0%{transform:translate(1px, 1px) rotate(0deg)}10%{transform:translate(-1px, -2px) rotate(-1deg)}20%{transform:translate(-3px, 0px) rotate(1deg)}30%{transform:translate(3px, 2px) rotate(0deg)}40%{transform:translate(1px, -1px) rotate(1deg)}50%{transform:translate(-1px, 2px) rotate(-1deg)}60%{transform:translate(-3px, 1px) rotate(0deg)}70%{transform:translate(3px, 1px) rotate(-1deg)}80%{transform:translate(-1px, -1px) rotate(1deg)}90%{transform:translate(1px, 2px) rotate(0deg)}100%{transform:translate(1px, -2px) rotate(-1deg)}}",
  map: null
};
const CallButtonOperator = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<div class="callObject" style="display: block;"><svg class="callButton svelte-jaz7he"${add_attribute("status", status, 0)} width="50" height="50" style="position:absolute;left:0px;top:5px;z-index: 30;"><g class="currentLayer svelte-jaz7he" style="stroke:lightgrey; stroke-width:10px"><title>Layer 1</title><path d="M390.7 353.3c-120.30000000000001 69.5 63.19999999999999 413.59999999999997 194.90000000000003 337.59999999999997l122.10000000000002 211.39999999999998c-55.60000000000002 32.10000000000002-102.5 52.30000000000007-166.9000000000001 15.5-178.79999999999995-102.19999999999993-375.59999999999997-442.9-369.99999999999994-646.0999999999999 1.8999999999999773-70.60000000000005 43.599999999999994-98.30000000000004 97.89999999999998-129.70000000000005 23.30000000000001 40.400000000000006 98.60000000000002 170.8 122 211.3z m50.400000000000034-5.699999999999989c-13 7.5-29.700000000000045 3.099999999999966-37.30000000000001-10l-115-199.3c-7.5-13.000000000000014-3.1000000000000227-29.700000000000017 10-37.30000000000001l60.5-34.900000000000006c13-7.499999999999993 29.69999999999999-3.0999999999999943 37.30000000000001 10l115.09999999999997 199.29999999999998c7.500000000000057 13 3.099999999999966 29.700000000000045-10 37.200000000000045l-60.599999999999966 35z m314.4 544.5c-13 7.5-29.700000000000045 3.1000000000000227-37.299999999999955-10l-115-199.30000000000007c-7.5-13-3.1000000000000227-29.699999999999932 10-37.299999999999955l60.5-34.89999999999998c13-7.5 29.699999999999932-3.1000000000000227 37.299999999999955 10l115.10000000000002 199.29999999999995c7.5 13 3.1000000000000227 29.700000000000045-10 37.30000000000007l-60.60000000000002 34.89999999999998z" id="svg_1" class="selected" transform="scale(.04)"></path></g></svg>  </div>`;
});
const BurgerButton_svelte_svelte_type_style_lang = "";
const css$1 = {
  code: "button.svelte-15vte99.svelte-15vte99{position:absolute;right:10px;top:0px;margin:5px;z-index:100;background-color:Transparent;background-repeat:no-repeat;border:none;cursor:pointer;overflow:hidden;outline:none}svg.svelte-15vte99 line.svelte-15vte99{stroke:currentColor;stroke-width:3}.open.svelte-15vte99 #top.svelte-15vte99{transform:translate(8px, 0px) rotate(45deg)}.open.svelte-15vte99 #mid.svelte-15vte99{opacity:0}.open.svelte-15vte99 #bot.svelte-15vte99{transform:translate(-15px, 8px) rotate(-45deg)}",
  map: null
};
const BurgerButton = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `<button style="${"position:fixed;transition: color " + escape(duration, true) + "s ease-in-out; color: " + escape(open ? menuColor : burgerColor, true) + ";"}" class="${["svelte-15vte99", open ? "open" : ""].join(" ").trim()}"><svg width="26" height="26" class="svelte-15vte99"><line id="top" x1="0" y1="8" x2="26" y2="8" style="${"transition: transform " + escape(duration, true) + "s ease-in-out, opacity " + escape(duration, true) + "s ease-in-out;"}" class="svelte-15vte99"></line><line id="mid" x1="0" y1="16" x2="26" y2="16" style="${"transition: transform " + escape(duration, true) + "s ease-in-out, opacity " + escape(duration, true) + "s ease-in-out;"}" class="svelte-15vte99"></line><line id="bot" x1="0" y1="24" x2="26" y2="24" style="${"transition: transform " + escape(duration, true) + "s ease-in-out, opacity " + escape(duration, true) + "s ease-in-out;"}" class="svelte-15vte99"></line></svg> </button>`;
});
const SideMenu_svelte_svelte_type_style_lang = "";
const css = {
  code: "#container.svelte-42ebs2{position:absolute;height:100vh;top:0px;overflow-y:auto}#menu.svelte-42ebs2{text-align:left}",
  map: null
};
const SideMenu = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  if ($$props.menuColor === void 0 && $$bindings.menuColor && menuColor !== void 0)
    $$bindings.menuColor(menuColor);
  $$result.css.add(css);
  return `<div id="container" style="${"position:fixed;z-index:1;background-color: " + escape(backgroundColor, true) + "; color: " + escape(menuColor, true) + "; width: " + escape(width, true) + "; right: " + escape(open ? "0px" : "-" + (parseInt(width) + 10) + "px", true) + "; transition: right " + escape(duration, true) + "s ease-in-out"}" class="svelte-42ebs2"><div id="menu" style="${"padding: " + escape(padding, true) + "; padding-top: " + escape(paddingTop, true) + ";"}" class="svelte-42ebs2">${slots.default ? slots.default({}) : ``}</div> </div>`;
});
...
const Operator = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  set_store_value(operatorst, $operatorst = operator, $operatorst);
  let container;
