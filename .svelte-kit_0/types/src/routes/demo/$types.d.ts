...
export type Errors = Kit.AwaitedErrors<typeof import('../../../../../src/routes/demo/+page.server.js').POST> | Kit.AwaitedErrors<typeof import('../../../../../src/routes/demo/+page.server.js').PATCH> | Kit.AwaitedErrors<typeof import('../../../../../src/routes/demo/+page.server.js').DELETE>;
export type PageServerData = Kit.AwaitedProperties<Awaited<ReturnType<typeof import('../../../../../src/routes/demo/+page.server.js').load>>>;
